...
public class LinhScriptVarAssignmentImpl extends ASTWrapperPsiElement implements LinhScriptVarAssignment {

  public LinhScriptVarAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }
